...
satpam = LINETCR.LINE() # Your Account
satpam.login(token="Emwj3NokLCQuoXJiNxg8.U40LLFZeiqqvp2ELpRnDEa.fiYpDoMXDDZTZ6w82PI1XQFYr6h6RGqPzKhAXgwfegU=")
satpam.loginResult()

cl = LINETCR.LINE() #Bot 1
cl.login(token="EmnDn8liuKszHjyKn7zb.vMPYCL8hejSKVeu0qJvRsW.Y6bdDRxHNW79hc0o6c+FHxIi76HSZPLVqOIkKM3LWAI=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 2
ki.login(token="EmoLPtjilVxSUgaaj8Lc.tG1cKK4yBu4/sWfTRtYX7a.3Y5fsdBN1eXueCfP0/4kWvJJqnPFKhuEsQZNvn8I1zk=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 3
kk.login(token="EmikKocBg3JnSSUz9ju3.jv3+yxUaeecutCFdxOjHyW.WwEKLPeBN163hHCXIoY+oGjiP5J6OYjE9nF7rWvfGH0=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 4
kc.login(token="EmuiImEnxYbeeEPAdgI5.02Qag6EWcTdvlB48NIm4Pq.HcOCzFN/F2nCn+eKB0JHEkMzdnCutahrVF0iBaEcI0o=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 5
ks.login(token="EmkQPkAsLrgIWFBcMtMc.HZPak9o7McUyV2fdelRrBa.y/hVIa7mTBY/d1GFarElRC3G5O+gafS7YgCNkA8POw4=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 6
ka.login(token="EmBr9Lm9Uezk9IcMh3We.yNyL3G4YDZvAB+tC+0MKhG.FU3basF3ewSfWo+gUbuAcWMPa7gHVPUXLxd8L6usT3o=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 7
kb.login(token="Empp5R8PaRgP5uMbcRX4.63cOW8qvlFf11z+Xj9Cvza.3LBOPe45GimUTVOh1WqmxmkHJ7PEl1cPTGHBD6asyCA=")
kb.loginResult()

ku = LINETCR.LINE() #Bot 8
ku.login(token="EmbRbOXNorDsamHeE968.y5nca7nKaWg4UQkEarJGca.szHBMWZTyJitvMPjI2CcAq5hyM1/qOuCADHljooSHnI=")
ku.loginResult()

ke = LINETCR.LINE() #Bot 9
ke.login(token="EmWzFjn6InwJTXqBsyh5.RwDWYAnFJxT4EAxoquQcnq.QMnR7kXQdeoQW05x5u1N4J08OHZb1paE2KqxfHEvYtE=")
ke.loginResult()

ko = LINETCR.LINE() # Bot 10
ko.login(token="Emr6DYwwuJTTvCuydJl0.wRi1r2xdT67qzaCt8gFsKa./6pyjro+o1DZ8jCm8mDoOGknfo+PrBlh4o2ZX1fb+3s=")
ko.loginResult()

k1 = LINETCR.LINE() # Bot Backup
k1.login(token="EmoMtJ2wZMG1ikHsKMMd.jdkQZo0zKkQfiX8wrn1wNq.B+VVDvzWTcPznF6B8Lqg7aWxPV8ShGJsS89478TFhRA=")
k1.loginResult()

print "Login Success Dude"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""Soheil Bot Protect
Owner : 👑Soheil👑
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
admin=["ubb8d2595fcc42104153f67a53eb35d78","ued156c86ffa56024c0acba16f7889e6d"] #Your Mid and Admin Mid
owner=["ubb8d2595fcc42104153f67a53eb35d78"] # Your Mid (Owner)
kawan=["ued156c86ffa56024c0acba16f7889e6d"] #Whitelist Mid
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Thanks For Adding Me On Your Friends
≫ Dont Chat Me, Coz Me Only Protect Bot ≪
≫ Sohail BOT PROTECT ≪
            ...
            if op.param3 in mid:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  time.sleep(0.01)
                  cl.sendText(op.param1, "Thanks Dude")
                  k1.sendText(op.param1, "Your Welcome Dude")
                  k1.sendText(op.param1, "I'm Out Dude\nAssalamualaikum")
            ...
            if op.param3 in Smid:
              if op.param2 not in Bots:
                try:
                  ...
                  time.sleep(0.01)
                  satpam.sendText(op.param1, "Thanks Dude")
                  k1.sendText(op.param1, "Your Welcome Dude")
                  k1.sendText(op.param1, "I'm Out Dude\nAssalamualaikum")
...
#--------------------------------                      
        ...
        if op.type == 26:
            ...
            elif "Bot7invite " in msg.text:
              if msg.from_ in owner:
                midd = msg.text.replace("Bot7invite ","")
                kb.findAndAddContactsByMid(midd)
                kb.inviteIntoGroup(msg.to,[midd])
            elif "Bot8invite " in msg.text:
              if msg.from_ in owner:
                midd = msg.text.replace("Bot8invite ","")
                ku.findAndAddContactsByMid(midd)
                ku.inviteIntoGroup(msg.to,[midd])
            elif "Bot9invite " in msg.text:
              if msg.from_ in owner:
                midd = msg.text.replace("Bot9invite ","")
                ke.findAndAddContactsByMid(midd)
                ke.inviteIntoGroup(msg.to,[midd])
            elif "Bot10invite " in msg.text:
              if msg.from_ in owner:
                midd = msg.text.replace("Bot10invite ","")
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Already Add Dude")
                        except:
                            pass
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Already Deleted")
                        except:
                            pass
...
#====================================================================
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        cl.sendText(msg.to,"We Are Already Added He's For Friends")
                      except:
                        cl.sendText(msg.to,"Error")
              else:
    ...
    #--------------= SC Ganti nama Owner=--------------
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Name Updated To : " + string + "")
    #-------------- copy profile----------
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Bot3 open qr","Bot3 buka qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).updateGroup(X)
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"QR Code Already Closed")
                    else:
                        random.choice(KAC).sendText(msg.to,"Already Closed Plak")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Bot1 close qr","Bot1 tutup qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Bot2 tutup qr","Bot2 close qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
            ...
            elif msg.text in ["Bot3 tutup qr","Bot3 close qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
              ...
              if msg.from_ in owner:
                ...
                if gid == "":
                  ...
                  try:
                    ...
                    cl.sendText(msg.to,"Maybe Me Not In Thats Group")
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Checking Sider...")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "type sider first friends  ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["In All","Bot in","Join Bot","Sign in"]:
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to, "You Not My Owner")
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye all","Bot out","Cao all"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"We Ready Like Owner Status")
                try:
                  likePost()
                except:
                  pass
              ...
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"We Ready Like Owner Friends Status")
                try:
                  autolike()
                except:
                  pass
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Out From All","Out from all"]:
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"Welcome To Group")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ke.sendText(msg.to,"⭐⭐")
                ku.sendText(msg.to,"⭐")
                cl.sendText(msg.to,"All Bots Already Present Dude\nReady Protect This Group")
...
#---------------------
        if op.type == 17:
          ...
          cl.sendText(op.param1, "👥Welcome To Group :👥\n" + "👉" + str(ginfo.name) + "👈" + "\n" + "👑Founder Grup👑" + str(ginfo.name) + "\n" + ginfo.creator.displayName + "\n\n" + "This Group Protected By :" + "\n⭐||Sohail Bot Protect||⭐")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          satpam.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          ka.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ka.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          kb.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kb.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          ku.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ku.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          ke.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ke.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          ko.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ko.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Sohail⭐⭐👈\n\nSohail Bot Protect")
          print "Like"
        except:
          pass
      else:
